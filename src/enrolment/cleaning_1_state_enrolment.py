...
file_path = r"UIDAI DATATHON'26 DATASETS\api_data_aadhar_enrolment-20260404T114207Z-3-001\api_data_aadhar_enrolment\enrolment_merged.csv"
...
if col_name:
    ...
    df.to_csv(r"UIDAI DATATHON'26 DATASETS\api_data_aadhar_enrolment-20260404T114207Z-3-001\api_data_aadhar_enrolment\enrolment_states_cleaned.csv", index=False)