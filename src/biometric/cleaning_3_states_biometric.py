...
file_path = r"UIDAI DATATHON'26 DATASETS\api_data_aadhar_biometric-20260404T114240Z-3-001\api_data_aadhar_biometric\biometric_merged.csv"
...
if col_name:
    ...
    df.to_csv(r"UIDAI DATATHON'26 DATASETS\api_data_aadhar_biometric-20260404T114240Z-3-001\api_data_aadhar_biometric\biometric_states_cleaned.csv", index=False)